...
const MiniProblem = ({ problem }) => {
    ...
    return (
        <div className={`p-6 bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition duration-300 ease-in-out border-2 ${borderClasses[color]}`}>
